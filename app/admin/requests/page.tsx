...
const initialRequests: Request[] = [
  {
    id: 1,
    name: "Eshita Kapat",
    img: "/path/to/userphoto.jpg", // Replace with actual image
    appliedFor: "E-Commerce Platform",
    domain: "Cloud",
    description: "I want to contribute.",
  },
...
export default function PendingRequests() {
  ...
  return (
    <div className="py-8 px-10">
      {/* Header */}
      <h2 className="font-mclaren font-normal text-[38px] text-[#2A2A4A] mb-3 leading-[100%]">
        Pending Requests
      </h2>
      <p className="text-[#606060] text-[18px] font-mclaren mb-8 leading-[100%]">
        Approve or reject member requests
      </p>
      ...
      <div className="flex flex-col items-start">
        {requests.map((request) => (
          ...
          >
            ...
            <div className="text-[#181818] text-[16px] font-mclaren mb-1">
              Applied for:{" "}
              <span className="font-semibold">{request.appliedFor}</span>
            </div>
            <div className="text-[#181818] text-[16px] font-mclaren mb-1">
              Domain: <span className="font-semibold">{request.domain}</span>
            </div>
        ...
        {/* Empty state */}
        {requests.length === 0 && (
          <p className="text-[#555] mt-6 text-lg font-mclaren">
            No pending requests
          </p>
        )}
      </div>
