  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-2 md:px-4 lg:px-8 lg:pt-8 pt-2">
          ...
          <div className="flex justify-end mb-4">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-indigo-500/50 transition-all duration-300"
            >
              <Edit size={16} />
          ...
          {/* Profile Header Card */}
          <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-indigo-500/20 shadow-2xl shadow-indigo-500/10 overflow-hidden">
            <div className="p-4 md:p-8">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                {/* Profile Photo */}
                <div className="relative group">
                  {/* <div className="absolute -inset-1 bg-indigo-600 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-300" /> */}
                  <div className="relative w-60 h-60 rounded-full overflow-hidden border-4 border-slate-900 ring-2 ring-indigo-500">
                    <Image
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-xl text-indigo-300 font-semibold mb-4">{profileData.designation}</p>
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-6">
                    ...
                    <a href={profileData.github} target="_blank" rel="noopener noreferrer"
                       className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 transition-colors group/link">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        {/* Skills Section */}
        <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-indigo-500/20 shadow-xl shadow-indigo-500/5 p-8">
          ...
          <div className="flex flex-wrap gap-3">
            {profileData.skills.map((skill, index) => (
              <span
                key={index}
                className="px-4 py-2 bg-indigo-500/20 border border-indigo-500/30 rounded-lg text-slate-200 font-medium hover:bg-indigo-500/30 transition-all duration-300 hover:scale-105 cursor-default"
              >
                {skill}
              </span>
            ))}
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-slate-900 rounded-3xl border border-indigo-500/30 shadow-2xl shadow-indigo-500/20 max-w-2xl w-full max-h-[90vh] overflow-hidden">
            {/* Modal Header */}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 bg-slate-800/50 border border-indigo-500/30 rounded-xl text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-slate-800/50 border border-indigo-500/30 rounded-xl text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                ...
                <div className="flex flex-wrap gap-2">
                  {editData.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="group flex items-center gap-2 px-4 py-2 bg-indigo-500/20 border border-indigo-500/30 rounded-lg text-slate-200 font-medium"
                    >
                      {skill}
                      <button
            ...
            {/* Modal Footer */}
            <div className="flex items-center justify-end gap-4 p-6 border-t border-indigo-500/20">
              <button
                onClick={() => setIsEditModalOpen(false)}
              ...
              <button
                onClick={handleSave}
                className="flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-indigo-500/50 transition-all duration-300"
              >
                <Save size={20} />
...
function StatCard({ icon, title, value, gradient }: StatCardProps) {
  return (
    <div className="group relative bg-slate-900/90 backdrop-blur-xl rounded-2xl border border-indigo-500/20 shadow-xl shadow-indigo-500/5 p-6 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 hover:scale-105">
      <div className={`absolute inset-0 bg-indigo-600 opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity duration-300`} />
      <div className="relative">
        <div className={`inline-flex p-3 bg-indigo-600 rounded-xl mb-4 shadow-lg`}>
