...
export default function TeamMembers() {
  return (
    <div className="min-h-screen py-8 px-6 ">
      <h2 className="font-mclaren font-normal text-[38px] text-[#2A2A4A] mb-3 leading-[100%] tracking-[0] mt-8">
        Team Members
      </h2>
      ...
      <div className="flex flex-wrap gap-8">
        {team.map((member) => (
          <div
            key={member.name}
            className="bg-white border border-gray-200 rounded-lg flex flex-col items-center px-8 py-6  w-[190px] shadow-xl"
          >
            <img
              src={member.img}
              alt={member.name}
