          ...
          <div className="bg-gray-900/70 backdrop-blur-lg p-8 w-full rounded-xl shadow-2xl border border-gray-700/50">
            <div className="flex items-center justify-between mb-6">
              ...
              <button 
                ...
                className="px-6 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 shadow-lg font-medium flex items-center gap-2"
              >
          ...
          <div className="bg-gray-900/70 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-gray-700/50">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm focus:border-emerald-500 focus:outline-none"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm focus:border-emerald-500 focus:outline-none"
                      />
                    </div>
                    <div>
              ...
              <div className="mt-4 md:mt-0 md:ml-4">
                {!isTimelineEditMode ? (
                  <button 
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 shadow-lg font-medium flex items-center gap-2"
                  >
                    <FaEdit className="text-sm" />
                    Edit
                  </button>
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium text-sm"
                    >
                      Save
                    </button>
                    <button 
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                ...
                className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-6 py-3 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 shadow-lg font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 text-white focus:border-emerald-500 focus:outline-none resize-none"
                />
              </div>
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 text-white focus:border-emerald-500 focus:outline-none"
                    />
                    <button
                      onClick={handleAddTechnology}
                      disabled={!newTechName.trim()}
                      className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {editTechnologies.map((tech) => (
                      <div
                        key={tech.id}
                        className="flex items-center gap-2 bg-gradient-to-r from-emerald-500/20 to-green-500/20 text-emerald-300 px-3 py-2 rounded-full text-sm font-medium border border-emerald-500/30 backdrop-blur-sm"
                      >
                        <span>{tech.name}</span>
                        <button
              ...
              <div className="flex gap-4 pt-4">
                <button 
                  ...
                  className="flex-1 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-6 py-3 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium"
                >
                  Save Changes
                </button>
                <button 
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 py-2 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium flex items-center gap-2"
                >
                  <FaPlus className="text-xs" />
                  Add Member
                </button>
                ...
                {teamMembers.map((member) => (
                  <div key={member.id} className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg border border-gray-700/30">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center font-semibold text-white text-sm">
                        {getInitials(member.name)}
                      </div>
                      <div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <select
                          ...
                          className="appearance-none bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 pr-8 text-white text-sm focus:border-emerald-500 focus:outline-none cursor-pointer"
                        >
            ...
            <div className="p-6">
              {projectImage ? (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 py-2 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium flex items-center justify-center gap-2"
                    >
                ...
                <div className="text-center space-y-4">
                  ...
                  <button
                    onClick={() => fileInputRef.current?.click()}
                    className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 py-3 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 font-medium flex items-center justify-center gap-2"
                  >
                    <FaUpload className="text-sm" />
                    Choose Image
                  </button>
