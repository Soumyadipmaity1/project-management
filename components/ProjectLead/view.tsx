          ...
          <div className="xl:flex-[2_1_0%] w-full space-y-8">
            ...
            <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800">
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                <div className="w-1 h-8 bg-fuchsia-600 rounded-full"></div>
                Project Details
              </h2>
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  <a
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                      project.githubLink
                        ? "bg-gray-800 hover:bg-gray-700 text-fuchsia-600"
            ...
            <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800">
              ...
              <div className="space-y-4 bg-gray-800/30 p-4 rounded-xl border border-gray-700">
                <div className="flex items-center gap-3">
                  <FaCircle className="text-fuchsia-600 text-xs" />
                ...
                <div className="flex items-center gap-3">
                  <FaCircle className="text-fuchsia-200 text-xs" />
                  <span className="text-gray-300 text-sm">
                    Target Date:{" "}
                    <span className="font-medium text-white">
                ...
                <div className="pt-3 space-y-2">
                  ...
                  <div className="flex justify-between items-center text-xs mt-2 text-gray-400">
                    <span>
                      <span className="font-semibold text-fuchsia-600">{elapsedDays}</span>{" "}
                      days elapsed
                    </span>
                    <span>
                      <span className="font-semibold text-fuchsia-600">{remainingDays}</span>{" "}
                      days left
                    </span>
                  </div>
                </div>
          ...
          <div className="xl:flex-[1_1_0%] w-full space-y-8">
            <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 sticky top-8">
              <h3 className="text-xl font-bold mb-6 text-white flex items-center gap-3">
                <div className="w-1 h-8 bg-gradient-to-r from-fuchsia-500 to-fuchsia-100 rounded-full"></div>
                Project Info
              </h3>
              ...
              <div className="space-y-6">
                <div className="p-4 bg-gray-800/30 rounded-xl border border-gray-700">
                  ...
                  <span className="text-white bg-gradient-to-r from-fuchsia-700 to-fuchsia-800 px-3 py-1 rounded-lg text-sm font-medium">
