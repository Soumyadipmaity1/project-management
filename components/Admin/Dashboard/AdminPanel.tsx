...
export default function MemberPanel() {
  ...
  return (
    <div className="pl-10 py-8 w-full ">
      <h2 className="font-mclaren font-normal text-[38px] leading-[100%] tracking-[0] mb-2 pt-10 text-[#2A2A4A]">Welcome back, Admin</h2>
      <p className="text-[#2A2A4AB0]  font-mclaren font-normal text-[18px] leading-[100%] tracking-[0] pt-2 mb-15">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8 w-full">
        {stats.map((stat, idx) => (
          <div key={idx} className="rounded-[15px] bg-[#eaf2ff] bg-opacity-70 border border-gray-300 p-6 font-bold shadow-lg flex flex-col justify-center items-center"
